...
class TableEditorials extends Component{
    ...
    constructor(props){
        ...
        this.editeditorial = this.editeditorial.bind(this);
                  ...
                  <TableRow key={i}  sx={{ '&:last-child td, &:last-child th': { border: 0 } }}> 
                    ...
                    <TableCell>
                      <Stack spacing={2} direction="row">
                        ...
                        <Button variant="contained" onClick={(e)=>this.deleteeditorial(row.id)}>Eliminar</Button>  
                      </Stack>
                      </TableCell>
                  </TableRow>
                ))}                
            ...
            <Modal 
                ...
                <Fade in={this.state.modalEdit}>
                  <Box sx={style}>
                    ...
                    <Button variant="contained" onClick={this.editEditorial}>Editar</Button>  
              ...
              <Modal 
                ...
                <Fade in={this.state.modalCreate}>
                  <Box sx={style}>
                    ...
                    <Button variant="contained" onClick={this.createEditorial}>Crear</Button>                  
                    </FormGroup>
                  </Box>
                </Fade>
              </Modal>
    ...
    export default TableEditorials;
